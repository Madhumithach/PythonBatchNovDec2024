...
sentence=input("Enter a Sentence for palindrome check")
sentence_array=sentence.split(" ")
reverse_string=""
for each in sentence_array:
    reverse_string= reverse_string+each[::-1 ]+" "
print("Reverse Sentence: ",reverse_string)
